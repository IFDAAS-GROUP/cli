...
type SecureShell interface {
	Connect(opts *sshoptions.SSHOptions) error
	InteractiveSession(stdin io.Reader, stdout io.Writer, stderr io.Writer) error
...
func (c *secureShell) Connect(opts *sshoptions.SSHOptions) error {
...
func (c *secureShell) InteractiveSession(stdin io.Reader, stdout io.Writer, stderr io.Writer) error {
	var err error
...
func (c *secureShell) validateTarget(opts *sshoptions.SSHOptions) error {
...
func fingerprintCallback(opts *sshoptions.SSHOptions, expectedFingerprint string) ssh.HostKeyCallback {
...
func (c *secureShell) shouldAllocateTerminal(opts *sshoptions.SSHOptions, stdinIsTerminal bool) bool {
	switch opts.TerminalRequest {
	case sshoptions.RequestTTYForce:
		return true
	case sshoptions.RequestTTYNo:
		return false
	case sshoptions.RequestTTYYes:
		return stdinIsTerminal
	case sshoptions.RequestTTYAuto:
